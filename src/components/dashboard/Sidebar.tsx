...
export function Sidebar({
  ...
  "w-64 -translate-x-full", mobileOpen && "translate-x-0")}>
      <div className="flex items-center h-[80px] px-4 border-b border-blue-200 relative">
        <Link to="/" className={cn("flex items-center gap-2 transition-all duration-300", 
      ...
      <div className="flex flex-col flex-1 gap-1 py-4 overflow-y-auto">
        {mainNavItems.map(item => <Link key={item.title} to={item.path} className={cn("sidebar-item hover:bg-[#3b73ed] transition-all duration-300", 
